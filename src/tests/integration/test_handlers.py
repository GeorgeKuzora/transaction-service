...
all_transactions_report_request = {
    'username': 'george',
    'start_date': day_before_now.isoformat(),
    'end_date': day_after_now.isoformat(),
}
none_transactions_report_request = {
    'username': 'george',
    'start_date': two_days_before_now.isoformat(),
    'end_date': day_before_now.isoformat(),
}
...
invalid_dates_transactions_report_request = {
    'username': 'george',
    'start_date': day_after_now.isoformat(),
    'end_date': day_before_now.isoformat(),
}
